    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 font-[family-name:var(--font-heading)] font-semibold text-2xl text-text">Welcome back</h1>
          <p className="mt-1 text-sm text-text-secondary">Sign in to access your assessments</p>
        </div>
